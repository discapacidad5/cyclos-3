...
<h3>認可すべき移転</h3>
あなたによって<a href="#authorized"><u>認可され</u></a>なければならない移転の概観を得るには、このウィンドウを使ってください。いつものように、フィールドを空のままにすると、そのフィールドについてすべての可能な値が検索結果に含まれます。したがって、どのフィールドも指定せずに「検索」ボタンを押すと、その結果は認可待ちのすべての支払いになります。<br><br>以下の検索基準を指定できます:
<ul>
