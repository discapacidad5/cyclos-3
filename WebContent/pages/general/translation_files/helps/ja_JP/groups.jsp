...
<ul>
	...
	<li><b>Eメールによってパスワードを送信する:</b> このオプションがチェックされた場合、管理者と仲介人について2つのオプションが現れます。第1のオプションでは、このグループのために新しいメンバーを作成する仲介人と管理者が、登録フォーム内にパスワードを入力しないことを選択できます。メンバーはすぐにEメールによって一時的なパスワードを受け取ります。メンバーはログイン時に新しいパスワードを入力するよう促されます。<br> 第2のオプションでは、管理者と仲介人がメンバープロフィールからパスワードをリセットできます。メンバーは上で述べたのと同じ方法で一時的なパスワードを受け取ります。<br> そのメッセージは、<a href="${pagePrefix}settings#mail"><u>メール設定</u></a>内で定められます。このオプションを使う場合、Eメールフィールドが必須であることを確認してください。これは、<a href="${pagePrefix}settings#local"><u>ローカル設定</u></a>内で設定できます。<br>
