...
<br><br><i>Как эта функция включается.</i><br>
...
<br><br>Для возможности импорта внешних операций в Систему следует произвести следующие действия:
<ol>
	<li>Проверьте <a
...
<br><br>При первом открытии этого окна в нем не будет полей в списке. Для добавления нового соответствия полей нажмите на  &quot;Добавить новое соответствие полей&quot;. Вам предстоит повторить это для всех полей файла операции.<br>
...
<br><br>Как только появятся список полей вы можете делать следующее.
<ul>
...
Нажмите &quot;Выполнить&quot; для сохранения.<br><br>
...
<br><br>Перетаскивайте поля мышью и нажмите "Выполнить".
<hr class="help">
...
<br><br><i>Как это включается?</i><br>
