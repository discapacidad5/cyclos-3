...
this menu item to show up autorisaties need to be set for the administration
group)

<br><br><i>How to get it working.</i><br>
For the module to be visible you will need the correct <a
	href="${pagePrefix}groups#manage_group_autorisaties_admin_system"><u>admin
autorisaties</u></a> in block &quot;External Accounts (bookkeeping)&quot;.
