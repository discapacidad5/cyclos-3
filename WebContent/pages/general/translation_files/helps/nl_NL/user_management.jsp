...
<span class="broker">
<ul>
	<li><b>Creating/registering members:</b> Provided you have the autorisaties for
...
<br><br>If there exists a broker group that has broker autorisaties to the group
...
autorisaties, track possible errors, and close accounts when people leave
the organization. 
...
autorisaties can disconnect a member by clicking the delete icon (<img border="0"
...
autorisaties, you can disconnect an operator by clicking the
