...
<ol>
	...
	the autorisaties. This can be found under the block &quot;Member records types&quot;
	in the administration <a href="${pagePrefix}groups#manage_group_autorisaties_admin_system"><u>
	autorisaties</u></a>; you will need to check the &quot;manage&quot; checkbox.
	...
	<li><b>Set autorisaties</b> Once the record type is created you need to define
...
<ol>
	...
	<br>
	<li><b>Set the autorisaties:</b> &quot;menu: users & groups > permission
	groups&quot;, and refer to the helps of these screens, as <a
		href="${pagePrefix}groups#manage_groups"><u>setting autorisaties</u></a> is
...
If you have the autorisaties, you may also create a new record by
